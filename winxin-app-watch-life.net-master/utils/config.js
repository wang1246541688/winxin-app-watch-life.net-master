...
var DOMAIN = "www.cone-shaped.top";
var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="创窝怪客"; //网站名称
var ABOUTID = 53; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var ZANIMAGEURL = 'https://www.cone-shaped.top/wp-content/uploads/2018/12/295514106881564062.jpg';//微信鼓励的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'www.cone-shaped.top' },
];
 //首页图标导航
...
var INDEXNAV = [
  { id: '1', name: '微课', image: '../../images/nav-icon1.png', url: '../list/list?categoryID=5', redirecttype: 'apppage', appid: '', extraData: '' },
  ...
  { id: '4', name: '论坛', image: '../../images/nav-icon4.png', url: '../list/list?categoryID=16', redirecttype: 'miniapp', appid: '', extraData: ''},
